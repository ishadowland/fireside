...
🚧 **Pre-development / Design phase.** Requirements clarified, architecture drafting in progress.

See:
- [`docs/requirements/`](./docs/requirements/) — Requirements clarification & decision log
